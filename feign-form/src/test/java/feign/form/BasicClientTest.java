...
class BasicClientTest {
  ...
  void testUpload () throws Exception {
    ...
    assertThat(API.upload(path.toFile()))
      .asLong()
      .isEqualTo(Files.size(path));
  }
  ...
  void testUploadWithParam () throws Exception {
    ...
    assertThat(API.upload(10, Boolean.TRUE, path.toFile()))
      .asLong()
      .isEqualTo(Files.size(path));
  }
  ...
  void testUnknownTypeFile () throws Exception {
    ...
    assertThat(API.uploadUnknownType(path.toFile()))
  ...
  void testFormData () throws Exception {
    ...
    assertThat(API.uploadFormData(formData))
      .isEqualTo("popa.txt:application/custom-type");
  }
